            ...
            <div class="grid gap-6 lg:grid-cols-[18rem_1fr] lg:items-start">
              ...
              <div class="grid auto-rows-auto gap-4 md:grid-cols-2">
                <article
                  ...
                  :key="service.title"
                  class="grid row-span-4 grid-rows-subgrid rounded-lg border border-zinc-200 bg-zinc-50 p-6 dark:border-zinc-800 dark:bg-zinc-900"
                >
                  <p
                    :aria-hidden="!service.badge"
                  >
                    <span
                      v-if="service.badge"
                      class="mb-3 rounded-md px-2.5 py-1 text-xs font-semibold bg-emerald-100 text-emerald-800 dark:bg-emerald-400/10 dark:text-emerald-300"
                    >
                      {{ service.badge }}
                    </span>
                  </p>
